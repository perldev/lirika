...
# 	$ref->{ct_aid}=get_real_aid($ref->{ct_aid});
	...
	if($ref->{ct_tid2_comis})
	{
		...
		push @del_transes,$ref->{ct_tid2_comis};
			...
			{	
					...
					$obj{ct_tid2_comis}=$self->add_trans($ref->{ct_tid2_comis});
	...
	ct_tid2_comis=?,
	ct_oid=?
	],undef,qq[пїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ #$ref->{ct_id} '$ref->{ct_comment}' ],
