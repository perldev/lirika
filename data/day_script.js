...
function set_iframe_src(ct_id,id)
{
   	$('#ident_form_frame').attr({src : ct_id });
	document.getElementById('ident_form_frame').onload = function(ct_id,id){ajax_ident_req_inlist(ct_id,id);};
}

function ajax_ident_req_inlist(ct_id,id){
